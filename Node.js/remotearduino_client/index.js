...
const MQTT_HOST_URL = process.env.MQTT_HOST || '【MQTTブローカのURL】';
const MQTT_CLIENT_ID = process.argv.MQTT_CLIENT_ID || '【MQTTでのクライアントID】';
...
const MQTT_TOPIC_CMD = process.env.MQTT_TOPIC_CMD || 'm5lite/cmd【M5StickCのMacアドレス】';
const MQTT_TOPIC_RSP = process.env.MQTT_TOPIC_RSP || 'm5lite/rsp【M5StickCのMacアドレス】';
